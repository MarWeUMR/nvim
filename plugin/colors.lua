...
-- local P = mw.styles.palette
-- local L = mw.styles.lsp.colors
...
local function general_overrides()
  highlight.all({
    ...
    { ["@lsp.type.property.lua"] = { link = "@boolean" } },
    ...
    -- Treesitter
    -----------------------------------------------------------------------------//
    { ["@keyword.return"] = { bold = true, italic = true, fg = { from = "Keyword" } } },
    ...
    -- Virtual Text
    { DiagnosticVirtualTextInfo = { bg = { from = "Normal" } } },
    { DiagnosticVirtualTextHint = { bg = { from = "Normal" } } },
    { DiagnosticVirtualTextWarn = { bg = { from = "Normal" } } },
    { DiagnosticVirtualTextError = { bg = { from = "Normal" } } },
    -- Sign column line
...
akinsho.augroup("UserHighlights", {
  event = "ColorScheme",
  command = function()
    user_highlights()
  end,
