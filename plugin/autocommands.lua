    ...
    core.augroup("External", {
        {
            ...
            pattern = "*",
            command = function()
                vim.o.titlestring = require("core.external").title_string()
            end,
        },
        {
            event = { "VimLeavePre" },
            pattern = "*",
            command = function()
                require("core.external").tmux.set_statusline(true)
            end,
        },
        {
            ...
            command = function()
                ...
                vim.defer_fn(function()
                    require("core.external").tmux.set_statusline()
                end, 1)
            end,
        },
    })
