return function()
  ...
  core.nnoremap('zR', ufo.openAllFolds, 'open all folds')
  core.nnoremap('zM', ufo.closeAllFolds, 'close all folds')
  core.nnoremap('zP', ufo.peekFoldedLinesUnderCursor, 'preview fold')
end
