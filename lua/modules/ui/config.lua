  ...
  require("nightfox").setup({
    groups = {
      carbonfox = {
        ...
        -- make normalfloat use transparent background
        NormalFloat = { link = "Normal" },
        Search = { link = "BufferVisibleTarget" },
        TelescopeSelection = { link = "BufferVisibleTarget" },
        TelescopePreviewLine = { link = "BufferVisibleTarget" },
        -- NoicePopup = { fg = "fg1", bg = "NONE" },
        -- LspFloatWinNormal = { fg = "fg1", bg = "#73daca" },
        -- FloatShadow = {},
        -- FloatShadowThrough = { bg = "#73daca" },
        -- CmpDocumentation = { bg = "#73daca" },
      },
    },
