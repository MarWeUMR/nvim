...
return {
  ...
  ["@defaultLibrary"] = { fg = c.blue, bg = c.none, style = "italic,bold" },
  ["@variable"] = { fg = c.white, bg = c.none },
  ["@variable.builtin"] = { fg = c.yellow, bg = c.none, style = "italic" },
  ["@variable.global"] = { fg = c.blue, bg = c.none, style = "bold" },
